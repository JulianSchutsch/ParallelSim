...
begin
   ...
   if DistributedSystems.MyGlobalID=DistributedSystems.FirstGlobalID then

      Put_Line("First Node, enter Receive loop");
      declare

         Results : array(DistributedSystems.FirstGlobalID..DistributedSystems.LastGlobalID) of Integer;
      ...
      begin
         Results(DistributedSystems.FirstGlobalID):=NodeResult;
      ...
      begin
         ...
         Implementation.SendMessage
           (Dest   => DistributedSystems.FirstGlobalID,
            Packet => Packet);
      end;
