...
package body GUI.Console is
   ...
   function CharacterInput
     (Item  : access Console_Type;
      ...
      return Boolean is
   begin
      Put("Getting Character for console :");
      ...
      Insert
        (Source   => Item.InputContent,
         Before   => Item.InputPosition,
         New_Item => To_String(Chars));

      Item.InputPosition:=Item.InputPosition+Length(Chars);

      Console_ClassAccess(Item).Msg_CharacterInput(Chars);
      return True;
   end CharacterInput;
   ---------------------------------------------------------------------------
